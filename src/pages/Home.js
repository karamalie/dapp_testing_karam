...
const Home = () => {
  ...
  const { setWalletColor, walletColor, setReloadFlag, reloadFlag } =
    useContext(Context);
        ...
        <div
          className={
            windowSize.innerWidth > 400
              ? "relative w-full h-[82px] pl-[63px] pr-20 py-[9px] bg-zinc-500 bg-opacity-10 justify-start items-center justify-between inline-flex"
              : "w-full relative h-[82px] pl-8 pr-4 py-[9px] bg-zinc-500 bg-opacity-10 justify-start items-center justify-between inline-flex"
          }
        >
          <div className=" rounded-xl justify-center items-center gap-2 inline-flex">
            ...
            <div className="text-neutral-50 text-lg font-normal font-['Neue Haas Grotesk Display Pro'] ">
              {logged_user}
            </div>
          </div>
          <div
            className={
              windowSize.innerWidth > 400
                ? "p-2 rounded-[79px] justify-end items-center gap-3 inline-flex"
                : "p-2 rounded-[79px] justify-end items-center gap-0 inline-flex"
            }
          >
              ...
              <div className="pr-2 justify-end items-center gap-2 flex">
                {localStorage.getItem("tria.wallet.store") !== null ? (
                  <div
                    ...
                    className="w-14 hover:text-red-700 cursor-pointer hover:transition duration-200 text-red-500 text-base font-medium font-['Neue Haas Grotesk Display Pro'] leading-snug tracking-tight"
                  >
                    Logout
                  </div>
                ) : (
            ...
            <div
              style={{ background: bg }}
              className={`w-12 h-12 justify-center items-center flex rounded-full`}
            >
              {avatar && (
                <img
                  alt="avatar"
                  className="w-12 h-12 rounded-[32.73px]"
                  src={avatar}
                />
              )}
            </div>
        ...
        {windowSize.innerWidth > 1200 ? (
          <div
            className={
              windowSize.innerWidth > 2000
                ? "w-[70vw] grid grid-cols-11 gap-5 "
                : "w-[100vw] grid grid-cols-11 gap-5 "
            }
          >
            <div className="col-span-4 mt-4 ml-10 h-full ">
              <div className="w-full h-[35%] px-5 py-0 bg-zinc-500 bg-opacity-5 rounded-[22px] backdrop-blur-[100px] flex-col justify-center items-center gap-5 inline-flex">
                {success === false ? (
                  <div className="p-[8.83px] flex-col justify-center items-center gap-2 flex">
                    <div className="text-neutral-50 text-xl font-normal font-['Neue Haas Grotesk Display Pro'] leading-normal tracking-tight mt-7">
                      Experience Tria's Personalised
                    </div>
                    <div className="text-neutral-50 text-5xl font-medium font-['Neue Haas Grotesk Display Pro'] leading-[67.20px] tracking-wide">
                      Embedded Wallet
                    </div>
                    <div
                      onClick={() => fundTriaWallet()}
                      className="w-1/2 mt-3 mb-10 h-[44px] cursor-pointer bg-gradient-to-r from-violet-400 to-indigo-500 rounded-[78px] backdrop-blur-[20px] justify-center items-center inline-flex"
                    >
                      <div className="justify-center items-center flex">
                  ...
                  <div>
                    <div className="self-stretch h-[73.67px] p-[8.83px] flex-col justify-center items-center gap-2 flex">
                      <div className="self-stretch text-center mt-10">
                        <span className="text-neutral-50 text-[22px] font-semibold font-['Neue Haas Grotesk Display Pro'] leading-relaxed tracking-wide">
                          0.001 MATIC
                        </span>
                        <span className="text-neutral-50 text-[22px] font-normal font-['Neue Haas Grotesk Display Pro'] leading-relaxed tracking-wide">
                          {" "}
                          has been sent to your wallet{" "}
                        </span>
                      </div>
                      <div className="self-stretch text-center text-neutral-50 text-lg font-semibold font-['Neue Haas Grotesk Display Pro'] leading-snug tracking-tight">
                        {logged_user}
                      </div>
                    </div>
                    <div className="w-full flex justify-center mt-10">
                      <div
                        ...
                        className="w-1/3 mb-10 h-[44px] cursor-pointer bg-gradient-to-r from-violet-400 to-indigo-500 rounded-[78px] backdrop-blur-[20px] justify-center items-center inline-flex"
                      >
                        <div className="justify-center items-center flex">
                          <div className="text-center text-white text-lg font-semibold font-['Neue Haas Grotesk Display Pro'] leading-normal tracking-tight">
                            View Details
              ...
              {localStorage.getItem("wagmi.connected") === null ? (
                <div className="w-full mt-3 relative h-[26%] p-4 bg-zinc-500 bg-opacity-10 rounded-[22px] flex-col justify-start items-start gap-5 inline-flex">
                  <div className="self-stretch  py-3 flex-col justify-center items-start flex">
                    <div className="self-stretch flex-col justify-center items-start gap-2 flex">
                      <div className="px-2 justify-center items-center inline-flex">
                        <div className="text-center text-white text-opacity-40 text-base font-medium font-['Neue Haas Grotesk Display Pro'] uppercase leading-tight tracking-tight">
                          Customizations
                        </div>
                      </div>
                      <div className="self-stretch justify-start items-center gap-5 inline-flex">
                        <div className="grow shrink basis-0 h-[75px] px-5 py-4 rounded-xl justify-start items-center gap-4 flex">
                          <div className="grow shrink basis-0 flex-col justify-center items-start gap-1 inline-flex">
                            <div className="self-stretch text-neutral-50 text-lg font-semibold font-['Neue Haas Grotesk Display Pro'] leading-snug tracking-tight">
                              Wallet color card
                            </div>
                            <div className="self-stretch text-neutral-50 text-opacity-40 text-sm font-medium font-['Neue Haas Grotesk Display Pro'] leading-[16.80px] tracking-tight">
                        ...
                        <div className="rounded-[29.40px] justify-center items-center gap-[14.40px] flex">
                          <div
                            onClick={() => {
                              setWalletColor("#0F52BA");
                              setReloadFlag(!reloadFlag);
                            }}
                            className={
                              walletColor === "#0F52BA"
                                ? "p-[9.60px] cursor-pointer border rounded-[34.80px] justify-center items-center flex"
                                : "p-[9.60px] cursor-pointer rounded-[34.80px] justify-center items-center flex"
                            }
                          >
                          ...
                          <div
                            onClick={() => {
                              setWalletColor("#FFA800");
                              setReloadFlag(!reloadFlag);
                            }}
                            className={
                              walletColor === "#FFA800"
                                ? "p-[9.60px] border cursor-pointer rounded-[34.80px] justify-center items-center flex"
                                : "p-[9.60px] cursor-pointer rounded-[34.80px] justify-center items-center flex"
                            }
                          >
              ...
              <div className="w-full h-[32%] mt-3 px-5 py-4 bg-zinc-500 bg-opacity-10 rounded-[22px] backdrop-blur-[100px] flex-col justify-center items-center gap-1 inline-flex">
                <div className="self-stretch py-2 justify-center items-center gap-4 inline-flex">
                  <div className="text-neutral-50 text-2xl font-semibold font-['Neue Haas Grotesk Display Pro'] leading-[28.80px] tracking-wide">
                    Terms & Conditions
                  </div>
                </div>
                <div className="self-stretch grow shrink basis-0 px-5 py-3 rounded-[78px] justify-start items-center inline-flex">
                  <div className="grow shrink basis-0 self-stretch justify-start items-center flex">
                    ...
                    <div className="grow shrink basis-0 text-white text-opacity-40 text-sm font-base font-['Neue Haas Grotesk Display Pro'] leading-tight tracking-tight">
                      This is a sample message for you to check how the sign
                      message will be displayed in the embedded wallet.
                    </div>
                  </div>
                </div>
                <div
                  onClick={() => callSign()}
                  className="w-1/3 mb-3 mt-2 h-[44px] cursor-pointer bg-gradient-to-r from-violet-400 to-indigo-500 rounded-[78px] backdrop-blur-[20px] justify-center items-center inline-flex"
                >
                  <div className="justify-center items-center flex">
                    <div className="text-center text-white text-lg font-semibold font-['Neue Haas Grotesk Display Pro'] leading-normal tracking-tight">
                      Sign
            ...
            <div className="col-span-2 h-full mt-4">
              <div className="w-full h-[97%] px-5 pt-4 pb-6 bg-zinc-500 bg-opacity-10 rounded-[22px] backdrop-blur-[100px] flex-col justify-between items-center inline-flex">
                <div className="py-2 justify-center items-center gap-4 inline-flex">
                  <div className="text-neutral-50 text-xl font-semibold font-['Neue Haas Grotesk Display Pro'] leading-[28.80px] tracking-wide">
                    Mint NFT
                  </div>
                </div>
                <div className="w-full text-white text-opacity-40 text-sm font-base font-['Neue Haas Grotesk Display Pro'] leading-tight tracking-tight">
                  This is an example on Polygon Testnet. Tria supports 100+
                  blockchains. Speak with the team to discuss more.
                </div>
                <div className="w-full mt-4 mb-5">
                  <span className="text-white text-opacity-40 text-sm font-base font-['Neue Haas Grotesk Display Pro'] leading-tight tracking-tight">
                    Supported NFTs:
                    <br />
                  </span>
                  <span className="text-white text-opacity-40 text-sm font-base font-['Neue Haas Grotesk Display Pro'] leading-tight tracking-tight">
                ...
                <div className="rounded-[16.97px] flex-col justify-center items-center flex">
                  <div className="w-[100%] relative">
                    <img
                      className="h-auto max-w-[200px] rounded-[22.48px]"
                  ...
                  <div className="self-stretch  px-[8.43px] py-[16.86px] rounded-[27.15px] justify-center items-center inline-flex">
                    <div className=" justify-center items-center flex">
                      <div className="text-center text-neutral-50 text-opacity-90 text-xl  font-light font-['Neue Haas Grotesk Display Pro'] leading-[30.23px] tracking-wide">
                        Concept #1
                      </div>
                    </div>
                  </div>
                ...
                <div
                  ...
                  className="w-2/3 mt-6 mb-2 h-[44px] cursor-pointer bg-gradient-to-r from-violet-400 to-indigo-500 rounded-[78px] backdrop-blur-[20px] justify-center items-center inline-flex"
                >
                  <div className="justify-center items-center flex">
                    <div className="text-center text-white text-lg font-semibold font-['Neue Haas Grotesk Display Pro'] leading-normal tracking-tight">
                      Mint
            ...
            <div className="mt-1 col-span-2">
              <div className="w-full mt-3 px-5 py-4 bg-zinc-500 bg-opacity-10 rounded-[22px] backdrop-blur-[100px] flex-col justify-center items-start gap-5 inline-flex">
                <div className="self-stretch py-0 justify-center items-center gap-4 inline-flex">
                  <div className="text-neutral-50 mt-1 text-xl font-semibold font-['Neue Haas Grotesk Display Pro'] leading-[28.80px] tracking-wide">
                    Send Token
                  </div>
                </div>
                <div className="w-full -mt-2 text-white text-opacity-40 text-sm mb-3 font-base font-['Neue Haas Grotesk Display Pro'] leading-tight tracking-tight">
                  Transfer token to any wallet. To test this, you can transfer
                  your Polygon Testnet token to a different existing address.
                </div>
                <div className="self-stretch flex-col mb-5 justify-center items-center gap-4 flex">
                    ...
                    <div className="grow shrink basis-0 h-[51px] px-5 py-4 bg-zinc-500 bg-opacity-10 rounded-xl justify-start items-center flex">
                      <div className="justify-start items-center flex">
                        <input
                          ...
                          className="w-full text-white focus:outline-none text-base font-semibold font-['Neue Haas Grotesk Display Pro'] leading-tight tracking-tight bg-transparent w-full"
                  ...
                  <div className="self-stretch h-12 px-5 py-4 bg-zinc-500 bg-opacity-10 rounded-xl justify-start items-center inline-flex">
                    <div className="justify-start items-center flex">
                      <input
                        ...
                        className="w-full text-white focus:outline-none bg-transparent text-base font-semibold font-['Neue Haas Grotesk Display Pro'] leading-tight tracking-tight"
                  ...
                  <div
                    ...
                    } w-2/3 mt-6 h-[44px] bg-gradient-to-r from-${
                      recepientAddress.length > 0 ? "violet-400" : "gray-100"
                    } to-indigo-500 rounded-[78px] backdrop-blur-[20px] text-white justify-center items-center inline-flex`}
                  >
                    <div className="justify-center items-center flex">
                      <div
                        className={`text-center text-${
                          recepientAddress.length > 0 ? "white" : "gray-400"
                        } text-lg  font-semibold font-['Neue Haas Grotesk Display Pro'] leading-normal tracking-tight`}
                      >
                        Send
                      </div>
                    </div>
          ...
          <div className="mx-4 mt-3">
            <div className="w-full  px-5 py-0 bg-zinc-500 bg-opacity-5 rounded-[22px] backdrop-blur-[100px] flex-col justify-center items-center gap-5 inline-flex">
              {success === false ? (
                <div className="p-[8.83px] flex-col justify-center items-center gap-2 flex">
                  <div className="text-neutral-50 text-xl font-normal font-['Neue Haas Grotesk Display Pro'] leading-normal tracking-tight mt-5">
                    Experience Tria's Personalised
                  </div>
                  <div className="text-neutral-50 text-5xl font-medium font-['Neue Haas Grotesk Display Pro'] leading-[67.20px] tracking-wide text-center">
                    Embedded Wallet
                  </div>
                  <div
                    onClick={() => fundTriaWallet()}
            ...
            {localStorage.getItem("wagmi.connected") === null ? (
              <div className="w-full mt-3 relative p-4 bg-zinc-500 bg-opacity-10 rounded-[22px] flex-col justify-start items-start gap-5 inline-flex">
                <div className="self-stretch  py-3 flex-col justify-center items-start flex">
                  <div className="self-stretch flex-col justify-center items-start gap-2 flex">
                    <div className="px-2 justify-center items-center inline-flex">
                      <div className="text-center text-white text-opacity-40 text-base font-medium font-['Neue Haas Grotesk Display Pro'] uppercase leading-tight tracking-tight">
            ...
            <div className="w-full mt-3 mb-3 px-5 py-4 bg-zinc-500 bg-opacity-10 rounded-[22px] backdrop-blur-[100px] flex-col justify-center items-start gap-5 inline-flex">
              ...
              <div className="self-stretch flex-col mb-5 justify-center items-center gap-4 flex">
                ...
                <div
                  ...
                  className={`cursor-${
                    recepientAddress.length > 0 ? "pointer" : "not-allowed"
                  } w-2/3 mt-6 h-[44px] bg-gradient-to-r from-violet-400 to-indigo-500 rounded-[78px] backdrop-blur-[20px] text-white justify-center items-center inline-flex`}
                >
                  <div className="justify-center items-center flex">
                    <div
                      className={`text-center text-${
            ...
            <div className="w-full mb-3 px-5 pt-4 pb-6 bg-zinc-500 bg-opacity-10 rounded-[22px] backdrop-blur-[100px] flex-col justify-between items-center inline-flex">
              ...
              <div
                onClick={() => callWriteContract()}
                className="w-2/3 mt-6 h-[44px] cursor-pointer bg-gradient-to-r from-violet-400 to-indigo-500 rounded-[78px] backdrop-blur-[20px] justify-center items-center inline-flex"
              >
                <div className="justify-center items-center flex">
                  <div className="text-center text-white text-lg font-semibold font-['Neue Haas Grotesk Display Pro'] leading-normal tracking-tight">
                    Mint
            ...
            <div className="w-full mt-3 px-5 py-4 bg-zinc-500 bg-opacity-10 rounded-[22px] backdrop-blur-[100px] flex-col justify-center items-center gap-1 inline-flex">
              ...
              <div
                onClick={() => callSign()}
                className="w-1/3 mt-6 h-[44px] cursor-pointer bg-gradient-to-r from-violet-400 to-indigo-500 rounded-[78px] backdrop-blur-[20px] justify-center items-center inline-flex"
              >
                <div className="justify-center items-center flex">
                  <div className="text-center text-white text-lg font-semibold font-['Neue Haas Grotesk Display Pro'] leading-normal tracking-tight">
                    Sign
